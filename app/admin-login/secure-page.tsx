...
export default function SecureAdminLoginPage() {
  ...
  const handleSendOTP = async (e: React.FormEvent) => {
    ...
    console.log("🔐 Admin OTP request for:", emailForm.email);
    ...
    try {
      ...
      if (result.success) {
        toast({
          ...
          description: "Please check your email inbox for the admin OTP code.",
        });
        
        setStep('otp');
        setTimeLeft(600); // 10 minutes
        
        console.log("✅ Admin OTP sent, switched to verification step");
      } else {
        toast({
  ...
  const handleVerifyOTP = async (e: React.FormEvent) => {
    ...
    console.log("🔐 Admin OTP verification for:", emailForm.email);
